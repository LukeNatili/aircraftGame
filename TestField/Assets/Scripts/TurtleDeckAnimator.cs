...
public class TurtleDeckAnimator : MonoBehaviour
{
    ...
    public string stateName = "Armature|Move Turtle Deck";
    ...
    private void Update()
    {
        bool deployed = planeController != null && planeController.CollapseTurtleDeck;
        ...
        animator.Play(stateName, 2, NormalizedTime);
    }
}
